...
{if $loggedin=="true"}	<link rel="alternate" type="application/rss+xml" title="{$site->title} Full Rss Feed" href="{$smarty.const.WWW_TOP}/rss?t=0&amp;dl=1&amp;i={$userdata.ID}&amp;r={$userdata.rsstoken}" />{/if}
	...
	<link href="{$smarty.const.WWW_TOP}/templates/BinNews/styles/style.css" rel="stylesheet" type="text/css" media="screen" />
...
<body {$page->body}>
	...
	<div id="statusbar">
		{if $loggedin=="true"}
			<p>Welcome back <a href="{$smarty.const.WWW_TOP}/profile">{$userdata.username}</a>. <a href="{$smarty.const.WWW_TOP}/logout">Logout</a></p>
		{else}
			<p><a href="{$smarty.const.WWW_TOP}/login">Login</a> or <a href="{$smarty.const.WWW_TOP}/register">Register</a></p>
		{/if}
	</div>
	{/strip}
