...
{/if}
	<link rel="shortcut icon" type="image/ico" href="{$smarty.const.WWW_TOP}/templates/Dusplic/images/favicon.ico"/>
...
<body {$page->body}>
	...
	<div id="logo">
		<a class="logolink" title="{$site->title} Logo" href="{$smarty.const.WWW_TOP}{$site->home_link}"><img class="logoimg" alt="{$site->title} Logo" src="{$smarty.const.WWW_TOP}/templates/Dusplic/images/logo_largeplushigh.png" /></a>
