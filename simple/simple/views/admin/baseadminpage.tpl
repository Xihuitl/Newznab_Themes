...
<head>
	...
	<link href="{$smarty.const.WWW_TOP}/../templates/simple/styles/admin.css" rel="stylesheet" type="text/css" media="screen" />
	...
	<script type="text/javascript" src="{$smarty.const.WWW_TOP}/../templates/simple/scripts/utils-admin.js"></script>
	<script type="text/javascript" src="{$smarty.const.WWW_TOP}/../templates/simple/scripts/jquery.multifile.js"></script>
