...
<table style="width:100%;" class="data highlight icons" id="coverstable">
	<tr>
		...
		<th>rating<br/><a title="Sort Descending" href="{$orderbyrating_desc}"><img src="{$smarty.const.WWW_TOP}/templates/simple/images/sorting/arrow_down.gif" alt="" /></a><a title="Sort Ascending" href="{$orderbyrating_asc}"><img src="{$smarty.const.WWW_TOP}/templates/simple/images/sorting/arrow_up.gif" alt="" /></a></th>
	</tr>
